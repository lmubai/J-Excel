...
/**
 * User: Hyberbin Date: 13-12-3 Time: 下午6:20
 */
public class AdapterUtil {
	 ...
	 */
	public static void invokeOutputAdapterMethod(IOAdapter adapter, Method method, DataBean dataBean, Object fieldValue, String fieldName, Cell cell) throws InvocationTargetException,
	 ...
	 * @throws IllegalAccessException
	 */
	public static Object invokeInputAdapterMethod(IOAdapter adapter, Method method, DataBean dataBean, Class type, String fieldName, Cell cell) throws InvocationTargetException,
			IllegalAccessException {
	 ...
	 * @throws IllegalAccessException
	 */
	public static void invokeValidateAdapterMethod(IOAdapter adapter, Method method, DataBean dataBean, Sheet sheet, int index, String fieldName) throws InvocationTargetException,
			IllegalAccessException {
