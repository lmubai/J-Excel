...
/**
 * 一个Sheet的数据模型 User: Hyberbin Date: 13-12-3 Time: 上午9:22
 */
				...
				for (Annotation annotation : annotations) {
					...
					if (AdapterConstant.inputConfigs.contains(annotation.annotationType().getSimpleName())) {
						...
						if (inputAdapter != null)
							fieldBean.setInputMethod(inputAdapter);
						...
						if (outputAdapter != null)
							fieldBean.setOutputMethod(outputAdapter);
						...
						if (validateAdapter != null)
							fieldBean.setValidateMethod(validateAdapter);
					}
				}
